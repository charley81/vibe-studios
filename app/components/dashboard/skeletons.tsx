  ...
  return (
    ...
    >
      <div className="flex p-4">
        ...
        <div className="ml-2 h-6 w-16 rounded-md bg-slate-200 text-sm font-medium"></div>
      </div>
...
export function InvoiceSkeleton() {
  return (
    <div className="flex flex-row items-center justify-between border-b border-slate-100 p-4">
    ...
    >
      ...
      <div className="flex grow flex-col justify-between rounded-xl bg-slate-100 p-4">
        ...
        <div className="flex items-center pb-2 pt-6">
          ...
          <div className="ml-2 h-4 w-20 rounded-md bg-slate-200"></div>
        </div>
      </div>
    </div>
  );
